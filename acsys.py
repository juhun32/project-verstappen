...
class AERO:
    CD, CL_Front, CL_Rear = range(3)

# For setCameraMode and gerCameraMode


class CM:
    Cockpit, Car, Drivable, Track, Helicopter, OnBoardFree, Free, Random, ImageGeneratorCamera, Start = range(
        10)
